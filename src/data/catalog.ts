...
export const COMPANY_CATALOG: FilterDef[] = [
  ...
  },
  {
    ...
    group: "Size & growth",
    kind: "range",
    range: { sub: E.FUNCTION, subLabel: "Department", defaultSub: "1", hint: "Select a department and enter its headcount range." },
  },
  {
    ...
    group: "Size & growth",
    kind: "range",
    range: { sub: E.FUNCTION, subLabel: "Department", defaultSub: "1", hint: "Enter percentage values (e.g. 10 to 50 means 10%–50% growth). Select a department." },
  },
